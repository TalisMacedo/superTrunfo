...
int main(){
  ...
  float areaUm, pibUm, densidadeUm, pibPerCapitaUm;
  ...
  scanf(" %d", &pontosTuristicosUm);
    ...
    densidadeUm = (float) populacaoUm / (float) areaUm;
  ...
  float areaDois, pibDois, densidadeDois, pibPerCapitaDois;
  ...
  densidadeDois = (float) populacaoDois / (float) areaDois;
